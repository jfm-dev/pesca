...
INSERT INTO `messages` (`id`, `type`, `message`, `user`, `send`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'E-mail', 'Vao pra casa.', 3, 9, '2023-07-11 18:26:28', '2023-07-11 20:54:49', NULL),
	(2, 'Mensagem', 'dwfewgewg', 3, 10, '2023-07-11 18:55:19', '2023-07-11 20:55:09', NULL);
...
-- Dumping data for table db_pesca.newsletter: ~3 rows (approximately)
INSERT INTO `newsletter` (`id`, `name`, `email`, `contact`, `register`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(6, 'Muculo', 'justivenciof@gmail.com', 841474480, 0, '2023-07-09 11:06:04', '2023-07-09 11:06:04', NULL),
	(7, 'Agatah', 'agah@gmail.com', 87542120, 0, '2023-07-16 09:57:23', '2023-07-16 10:13:27', NULL),
	(8, 'tyrtyr', NULL, 84547777, 1, '2023-07-16 09:57:39', '2023-07-16 09:57:39', NULL),
	(11, 'thrhweh', '', 435435435, 1, '2023-07-16 10:19:19', '2023-07-16 10:19:19', NULL);
...
-- Dumping data for table db_pesca.notices: ~1 rows (approximately)
...
INSERT INTO `users` (`id`, `name`, `born_day`, `gender`, `school_level`, `status`, `username`, `password`, `email`, `contact`, `token`, `user_level`, `department`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(3, 'Adminstrador do sistema', NULL, '', '', 1, 'admin', '$2y$10$wmfj8HwUBJScVFoOI9OdkeKne7PH3tcpl6GH.MpuGIifi0otctKE6', 'justivenciof@gmail.com', 0, 'b8b85d9ea572ffe6efd5c86afc36adce026a989ef6755e994a40a3f7743cc513', 1, 1, '2023-06-11 11:54:06', '2023-07-16 10:27:03', NULL),
