...
<head>
  ...
  <!-- Favicons -->
  <link href="<?= base_url('assets/site/img/favicon.png') ?>" rel="icon">
  <link href="<?= base_url('assets/site/img/apple-touch-icon.png') ?>" rel="apple-touch-icon">

  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">

  <!-- Vendor CSS Files -->
  <link href="<?= base_url('assets/site/vendor/animate.css/animate.min.css') ?>" rel="stylesheet">
  ...
  <link href="<?= base_url('assets/site/vendor/remixicon/remixicon.css') ?>" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center  header-transparent ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="javascript:void()">Pesca</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#testimonials">Testemonials</a></li>       
          <li><a class="nav-link scrollto" href="#contact">Contact</a></li>
          <li><a class="nav-link scrollto" href="<?= url_to('login') ?>">Entrar</a></li>
        </ul>
  ...
  <script src="<?= base_url('assets/site/vendor/isotope-layout/isotope.pkgd.min.js') ?>"></script>
